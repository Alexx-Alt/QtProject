...
public:
    ...
    void setupUi(QWidget *login)
    {
        ...
        NameLabel->setGeometry(QRect(40, 20, 113, 23));
        EmailLabel = new QLineEdit(registerframe);
        EmailLabel->setObjectName("EmailLabel");
        EmailLabel->setGeometry(QRect(40, 60, 113, 23));
        PasswordLabel = new QLineEdit(registerframe);
        PasswordLabel->setObjectName("PasswordLabel");
        PasswordLabel->setGeometry(QRect(40, 90, 113, 23));
        ...
        NameLabel2->setGeometry(QRect(50, 20, 113, 23));
        PasswordLabel2 = new QLineEdit(frame);
        PasswordLabel2->setObjectName("PasswordLabel2");
        PasswordLabel2->setGeometry(QRect(50, 50, 113, 23));
    ...
    void retranslateUi(QWidget *login)
    {
        ...
        loginButton->setText(QCoreApplication::translate("login", "\320\227\320\260\321\200\320\265\320\263\320\265\321\201\321\202\321\200\320\270\321\200\320\276\320\262\320\260\321\202\321\214\321\201\321\217", nullptr));
        ...
        RegistrationButton->setText(QCoreApplication::translate("login", "\321\200\320\265\320\263\320\270\321\201\321\202\321\200\320\260\321\206\320\270\321\217", nullptr));
    } // retranslateUi
